<template>
    <div class="flex justify-center items-center font-[sans-serif] text-[#333] h-full min-h-screen p-4" style="
            background-image: url(/images/—Pngtree—dark\ fitness\ room\ with\ training_4839864.jpg);
            background-repeat: no-repeat;
            background-size: cover;
        ">
        <div class="max-w-md w-full mx-auto">
            <form @submit.prevent="login"
                class="bg-opacity-70 bg-white rounded-2xl p-6 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
                <div class="mb-10">
                    <h3 class="text-3xl font-extrabold">Login</h3>
                    <p class="bg-red text-center" v-if="message">
                        {{ message }}
                    </p>
                </div>
                <div>
                    <div class="relative flex items-center">
                        <input name="email" v-model="user.email" type="text" required
                ...
                <div class="mt-8">
                    <div class="relative flex items-center">
                        <input name="password" v-model="user.password" type="password" required
                            class="bg-transparent w-full text-sm border-b border-[#333] px-2 py-3 outline-none placeholder:text-[#333]"
                ...
                <div class="flex items-center justify-between gap-2 mt-6">
                    <div class="flex items-center">
                        ...
                        <label for="remember-me" class="ml-3 mt-2.5 block text-sm">
                            Remember me
                        </label>
                    </div>
                    <div>
                ...
                <div class="mt-10">
                    ...
                    <p class="text-sm text-center mt-6">
                        ...
                        <router-link to="/register" class="font-semibold hover:underline ml-1 whitespace-nowrap">
