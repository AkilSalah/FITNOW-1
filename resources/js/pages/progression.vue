<template>
  ...
  <div class="relative bg-gradient-to-r mt-1 from-purple-900 to-black-800 py-16 font-[sans-serif]">
    <div class="absolute inset-0">
      <img
        src="https://cdn.shopify.com/s/files/1/0297/0366/7845/files/full_planche_trois_doigts_1024x1024.png?v=1612756362"
        alt="Background Image" class="w-full h-full object-cover opacity-50" />
    </div>
    <div class="relative max-w-screen-xl mx-auto px-8 z-10 text-center text-white">
      ...
      <router-link to="/home">
        <button type="button"
          class="bg-indigo-600 hover:bg-indigo-700 text-white text-base font-semibold px-8 py-2.5 rounded-full transition duration-300 ease-in-out shadow-lg hover:shadow-xl">Ajouter
          une Progression</button>
      </router-link>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr v-for="progression in progressionData" :key="progression.id"
          ...
          <td class="flex items-center px-6 py-4">
            <button @click="updateModal(progression)" 
            ...
            <div v-if="progression.status !== 'terminé'">
              <button @click="complete(progression)"
                    ...
                    <form class="mt-16 font-[sans-serif] m-6 max-w-4xl mx-auto">
                      <div class="grid sm:grid-cols-2 gap-10">
                        ...
                        <div class="relative flex items-center sm:col-span-2">
                          ...
                          <input v-model="editedProgression.TempsDeCourse" type="number"
